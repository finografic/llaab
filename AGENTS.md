...
- **Grid layout (mandatory):** **Always** use `Row`/`Col`/`Container` from `components/ui/grid` for
  ...
  sites: `crons.tsx`, `inbox.tsx`, registry list/detail, `TerminalPanel.tsx` (`Col lg="content"`).
