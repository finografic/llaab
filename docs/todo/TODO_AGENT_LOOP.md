# TODO — Agent Loop Infrastructure

> **Status:** Not started. `apps/server` and LLM layer are done — this is unblocked.
> Unlocks: Source Auto-Follow, `agent.run` command in Terminal Panel.
