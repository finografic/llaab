...
import { completeLlmBodySchema, updateLlmRouteBodySchema } from './llm.schema.js';
...
export const llmRouter = createRouter()
  ...
  .patch(
    routes.updateRouting.path,
    zValidator('json', updateLlmRouteBodySchema),
    routes.updateRouting.handler,
  )
