...
| `vault-nodes.routes.ts`       | Node CRUD        | `vaultTree`, `cleanRecent`, `file`, `listVaultNodes`, `createVaultNode`, `createVaultResourceNode`, `batchUpdateVaultNodes`, `nodeDetail`, `updateVaultNode`, `nodeRaw`          |
